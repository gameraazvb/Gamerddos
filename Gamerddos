...
print "credit : owner"
print "Author   : owner"
print "user   : gameraazvb 
print "Github   : github.com/gameraazvb"
print "youtube : youtube.com/lynx_countryballeredits"
print "twitter : twitter/gameraazvb"
